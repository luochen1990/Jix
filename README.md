...
The first point that distinguishes it from the Nix language is its static typing system, which can perform AOT type checking and offers first-class support for a mergable module system, which can be used as an alternative to the NixOS module system;
